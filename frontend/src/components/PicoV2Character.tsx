...
function PicoV2Character() {
  ...
  return (
    <div className="flex w-full h-screen bg-gradient-to-br from-slate-50 via-pink-50 to-purple-100">
      {/* 왼쪽 - Rive 애니메이션 */}
      ...
      <div className="w-1/2 p-8 flex flex-col">
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 h-full border border-white/20">
          ...
          <div className="flex gap-x-3 mb-8 flex-wrap">
            <button
              className="bg-pink-500 hover:bg-pink-600 rounded-xl text-white px-4 py-2 font-medium shadow-lg transition-all duration-200 hover:cursor-pointer"
              onClick={(_e: any) => {
